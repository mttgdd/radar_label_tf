...
# Root path for ori_data dataset.
ORI_ROOT="${WORK_DIR}/ori_data"
...
OUTPUT_DIR="${ORI_ROOT}/tfrecord"
mkdir -p "${OUTPUT_DIR}"

BUILD_SCRIPT="${CURRENT_DIR}/build_ori_data.py"

echo "Converting ori_radar dataset..."
python "${BUILD_SCRIPT}" \
  --ori_root="${ORI_ROOT}" \
